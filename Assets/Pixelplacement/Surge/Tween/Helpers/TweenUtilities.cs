...
namespace Pixelplacement.TweenSystem
{
    public class TweenUtilities : MonoBehaviour
    {
        //Public Methods:
        /// <summary>
        /// Generates the code to contain an Animation Curve in a property for use in storing blurEase curves within the Tween engine class.
        /// </summary>
        ...
        {
            return (to - from) * percentage + from; //this approach is needed instead of a simple Mathf.Lerp to accommodate blurEase cuves that overshoot
        }
